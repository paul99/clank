...
package com.google.android.apps.chrome.database;
...
public class SQLiteCursor extends AbstractCursor {
    private static final String TAG = "com.google.android.apps.chrome.database.SQLiteCursor";
    // Used by JNI.
     ...
     * @return the given column's type defined in java.sql.Types. The supported
     *         types are LONGVARCHAR, BLOB, NULL, NUMERIC and DOUBLE.
     */
