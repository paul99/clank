  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'ext/online_resizer.cc',
        'ext/online_resizer.h',
      ...
      'conditions': [
        ...
        [ 'OS == "android"', {
          ...
          'conditions': [
            ['use_system_skia==1', {
              # On Android we can optionally use the platform skia. We pull
              # the Android version of the Skia sources into third_party/skia
              # so that we are also using the same includes (which are
              # exported to dependents below).
              'dependencies': [
                'symbolic_link_android_skia',
              ],
              'defines': [
        ...
        [ 'OS == "android"', {
          # Android use the linux version of these files.
          'sources/': [
        ...
        [ 'OS == "android"', {
          ...
          'conditions': [
            [ '_toolset == "target"', {
              ...
              'dependencies': [
                # NOTE(petamerge): Intentionally different from upstream as we
                # can use android system and don't have freetype readily available.
                '../build/android/system.gyp:ft2',
...

    {
      ...
      'sources': [
        ...
        'ext/online_resizer_unittest.cc',
        'ext/run_all_unittests.cc',
      ],
    },
  ],
  'conditions': [
    [ 'OS=="android" and use_system_skia==1', {
      'targets': [{
        'target_name': 'symbolic_link_android_skia',
        'type': 'none',
        'actions': [{
          'action_name': 'symbolic_link_android_skia',
          'inputs': [],
          'outputs': [
            '../third_party/skia/SYMBOLIC_LINKED',
          ],
          'action': [
            '/bin/sh',
            '-c',
            'rm -rf ../third_party/skia; mkdir -p ../third_party/skia; ln -sf <(android_src)/external/skia/include ../third_party/skia; touch ../third_party/skia/SYMBOLIC_LINKED',
          ],
        }],
      }],
    }],
