...
// Initializes the components used to composite the user agent.
void InitUserAgent(std::string os_info, std::string mobile, std::string chrome_version);

// Returns a user agent for desktop Chrome.
