  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'test_streamtextureproxy_factory_android.cc',
        'test_streamtextureproxy_factory_android.h',
        'webkit_support.cc',
        'webkit_support.h',
      ...
      'conditions': [
        ...
        ['OS=="android"', {
          'dependencies': [
            '<(DEPTH)/clank/native/native.gyp:jni_headers',
          ...
          'sources': [
            '<(DEPTH)/content/browser/android/jni_helper.cc',
            '<(DEPTH)/content/browser/android/jni_helper.h',
            '<(DEPTH)/content/browser/android/media_player_bridge.cc',
            ...
            '<(DEPTH)/content/browser/android/surface_texture_listener.h',
          ],
          'direct_dependent_settings': {
            'libraries': [
              '<(android_lib)/libbinder.so',
              '<(android_lib)/libutils.so',
            ],
          },
        }],
      ],
