...
# found in the LICENSE file.
{
  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['OS=="android"', {
          'dependencies': [
            'chrome_resources.gyp:packed_resources', # for chrome.pak
            '../clank/native/native.gyp:jni_headers',
          ],
          'includes': [
            # TODO(bulach): this is shared between chrome_tests.gyp and clank.gyp,
            # we should remove this inter-dependency.
            '../clank/native/native.gypi',
          ],
          'sources': [
            '<@(clank_common_files)',
            'browser/android/partner_bookmarks_shim_stubs.cc',
            '../chrome/test/unittests_stub_android.cc',
          ],
          'include_dirs': [
    ...
    },
    {
      ...
      'dependencies': [
        ...
        # There were some run time dependencies and moved to section of
        # following condition [OS!="android"] because dependencies can not
        # be excluded and android platfrom does not need those dependencies.
      ],
      'include_dirs': [
        '..',
      ],
      ...
      'conditions': [
        ...
        ['OS=="android"', {
          'sources/': [
            # UI tests do not work in Clank; this makes the binary build and
            # trivially pass (by running 0 tests).
            ['exclude', '.'],
          ],
        }, { # else: OS != "android"
          'dependencies': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/extensions/api/webrequest/webrequest_api_unittest.cc',
        'browser/extensions/api/webrequest/webrequest_time_tracker_unittest.cc',
        ...
        'browser/tab_contents/auto_login_infobar_unittest.cc',
        ...
        'browser/ui/views/aura/launcher_icon_updater_unittest.cc',
      ...
      'conditions': [
        ...
        ['OS=="android"', {
          ...
          'sources/': [
            ...
            ['exclude', '^browser/sync/glue/preference_'],
          ...
          'sources': [
            '../content/renderer/android/address_detector_unittest.cc',
            'browser/img_bg_color_helper_unittest.cc',
            '../content/renderer/android/email_detector_unittest.cc',
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/chromeos/ui/volume_bubble_browsertest.cc',
        ...
        'browser/extensions/api/webrequest/webrequest_apitest.cc',
      ...
      'conditions': [
        ...
        ['OS=="android"', {
          ...
          'dependencies': [
            ...
            '../clank/tools/rebootondisconnect/rebootondisconnect.gyp:rebootondisconnect',
          ],
        }],
        ['OS=="win"', {
          'conditions': [
    ...
    },
    {
      ...
      'conditions': [
        ...
        ['OS=="android"', {
          'sources': [
            'browser/sync/notifier/sync_notifier_impl_android_unittest.cc',
          ],
          'dependencies': [
            '../third_party/cacheinvalidation/cacheinvalidation.gyp:cacheinvalidation',
          ],
          'sources!': [
            # Sources are excluded on android, so tests should be excluded
            'browser/sync/notifier/cache_invalidation_packet_handler_unittest.cc',
            'browser/sync/notifier/chrome_invalidation_client_unittest.cc',
            'browser/sync/notifier/chrome_system_resources_unittest.cc',
            'browser/sync/notifier/invalidation_notifier_unittest.cc',
            ...
            'browser/sync/notifier/p2p_notifier_unittest.cc',
            'browser/sync/notifier/registration_manager_unittest.cc',
            # Extensions aren't used/synced on android.
            'browser/sync/util/extensions_activity_monitor_unittest.cc',
          ],
        }, {
         # OS != android
    ...
    },
    {
      ...
      'sources': [
        ...
        # 'test/gpu/webgl_conformance_tests.cc',  # Clanker commented this out?
  ...
  'conditions': [
    ...
    ['OS == "mac" or OS == "win" or OS=="android" or (os_posix == 1 and target_arch == python_arch)', {
      'targets': [
        {
    ...
    }],  # ['OS=="mac" or OS=="win" or (OS=="linux" and target_arch==python_...
