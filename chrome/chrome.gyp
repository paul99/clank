  ...
  'variables': {
    ...
    'conditions': [
      ...
      ['OS=="android"', {
       ...
       'platform_locale_settings_grd':
         ## FIXME(ACW) this is probably a temporary solution as Clank might have
         ## its own strings
      ...
      ['os_posix == 1 and OS != "mac" and OS != "android" and OS != "linux"', {
        'platform_locale_settings_grd':
            'app/resources/locale_settings_linux.grd',
      },],
      ['OS=="mac"', {
  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/sync/util/experiments.h',
    ...
    # A library for sending and receiving server-issued notifications.
    {
      ...
      'conditions': [
        ['OS=="android"', {
          'sources': [
            'browser/sync/notifier/sync_notifier_impl_android.h',
            'browser/sync/notifier/sync_notifier_impl_android.cc',
            'browser/sync/notifier/android_notification_listener.h',
            'browser/sync/notifier/android_notification_listener.cc',
          ],
          'sources!': [
            'browser/sync/notifier/cache_invalidation_packet_handler.cc',
            'browser/sync/notifier/cache_invalidation_packet_handler.h',
