...
class ThumbnailDatabase {
 public:
  ...
  // Set a flag to indicate whether icon mapping should be synced.
  void SetSyncIconMappings(bool sync);

  // Return true if the icon mapping should be synced.
  bool ShouldSyncIconMappings();
#endif
