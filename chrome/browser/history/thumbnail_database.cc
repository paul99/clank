...
static const char* kSyncIconMappingKey = "android_sync_icon_mapping";
#endif
...
void ThumbnailDatabase::SetSyncIconMappings(bool sync) {
  meta_table_.SetValue(kSyncIconMappingKey, sync ? 1 : 0);
}

bool ThumbnailDatabase::ShouldSyncIconMappings() {
  int value = 0;
  meta_table_.GetValue(kSyncIconMappingKey, &value);
