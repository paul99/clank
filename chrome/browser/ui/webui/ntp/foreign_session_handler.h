...
class ForeignSessionHandler : public content::WebUIMessageHandler,
 ...
 private:
  ...
  // Allow a foreign session to be deleted from the ui
  ...
  bool SessionTabToValue(SessionModelAssociator* associator,
                         const SessionTab& tab,
                         DictionaryValue* dictionary);
  bool SessionWindowToValue(SessionModelAssociator* associator,
