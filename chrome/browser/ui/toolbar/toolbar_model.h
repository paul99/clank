...
class ToolbarModel {
 public:
  ...
  // For android, rather than having one ToolBarModel per browser, we have one
  // per LocationBar.
  explicit ToolbarModel(content::NavigationController* const navigation_controller);
#endif  // OS_ANDROID
...
#if defined(OS_ANDROID)
  content::NavigationController* const navigation_controller_;
#endif  // OS_ANDROID
