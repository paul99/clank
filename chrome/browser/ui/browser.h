...
class Browser : public TabHandlerDelegate,
 ...
 public:
  ...
  bool has_window() const { return window_; }
 ...
 private:
  ...
  virtual void DidNavigateMainFramePostCommit(content::WebContents* tab) OVERRIDE;
  ...
  /////////////////////////////////////////////////////////////////////////////
  // Overriden from SyncedBrowserDelegate

  // Methods originating from the TabStripModel.
  virtual int GetIndexOfTabContents(const TabContentsWrapper* tab) const;
