...
// megamerge: This class showed up in a download manager refactor
// (content/chrome), but I don't think we want to use it.  We probably
// need a Clank-specific DownloadManagerDelegate.
