...
#if (defined(OS_WIN) && defined(GOOGLE_CHROME_BUILD)) || defined(OS_ANDROID)
  // Returns the value for the Chrome Omnibox rlz.
  virtual string16 GetRlzParameterValue() const;
#endif

  // The optional client parameter passed with Google search requests.
  virtual std::string GetSearchClient() const;
  static void SetSearchClient(const std::string& client);
