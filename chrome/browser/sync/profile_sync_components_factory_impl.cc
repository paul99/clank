...
void ProfileSyncComponentsFactoryImpl::RegisterDataTypes(
  ...
  // Password sync does not work on clank. We do not have a default passphrase.
...
#if !defined(ANDROID_BINSIZE_HACK)
  // Clank doesn't sync preferences or have extensions.
...
ProfileSyncComponentsFactory::SyncComponents
    ProfileSyncComponentsFactoryImpl::CreatePreferenceSyncComponents(
        ...
        UnrecoverableErrorHandler* error_handler) {
#if !defined(ANDROID_BINSIZE_HACK)
  // Clank doesn't sync preferences.
