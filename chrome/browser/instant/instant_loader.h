...
class InstantLoader : public content::NotificationObserver {
 public:
  ...
  bool main_frame_committed() const { return main_frame_committed_; }
#endif
...
#if defined(OS_ANDROID)
  // Used by Android instead of ready_, since the instant tab is not shown,
  // ready_ does not get set.
  bool main_frame_committed_;
#endif
