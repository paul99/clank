...
class InstantLoaderDelegate {
 public:
  ...
  virtual void SwappedTabContents(InstantLoader* loader) = 0;
   ...
   // Called when a new TabContents has been created.
  virtual void TabContentsCreated(TabContentsWrapper* tab_contents_wrapper) = 0;

#if defined(OS_ANDROID)
  // Called when the load caused an interstitial page to be shown.
