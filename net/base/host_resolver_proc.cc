...
int SystemHostResolverProc(const std::string& host,
  ...
  // TODO(joth): Remove when http://b/3489275 is closed.
  // There are unproven reports that getaddrinfo sometimes leaves ai == NULL
  // on Android. Make an extra check to help track this down.
  CHECK(ai);
#endif
