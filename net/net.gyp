  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'base/abstract_linux_socket.cc',
        'base/abstract_linux_socket.h',
        ...
        'base/network_change_notifier_linux_android.cc',
        'base/network_change_notifier_linux_android.h',
      ...
      'conditions': [
        # Clank merge: This will attempt to build base.gyp:base for host, which
        # is not possible at the moment. Chromium revision 101378 requires this.
        ['OS!="android"', {
          'dependencies': [
        ...
        [ 'OS == "android"', {
            ...
            'dependencies': [
              ...
              # TODO: Move the native.gyp to base/android/
      ...
      # To include any files ending with *_linux, it must be done in a
      # 'target_conditions' block as that is evaluated after all linux files
      # are excluded in build/common.gypi.  The regex's are also evaluated
      # at the end, so use the regex sources[/] version.
      'target_conditions': [
        ['OS == "android"', {
          'sources/': [
            ['include', '^base/platform_mime_util_linux\\.cc$'],
            ['include', 'base/network_change_notifier_netlink_linux\\.cc$'],
          ],
        }],
      ],
    },
    {
      ...
      'conditions': [
        ...
        [ 'OS == "android"', {
          'sources!': [
            # No res_ninit() et al on Android, so this doesn't make a lot of sense.
            'dns/dns_config_service_posix_unittest.cc',
          ],
        }],
        [ 'use_glib == 1', {
