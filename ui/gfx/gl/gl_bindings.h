...
// Undefine some symbols from frameworks/base/opengl/include/GLES2/gl2.h
// (Android-side header) that probably should not be there to avoid a duplicate
// symbol warning that is harmless.
#undef GL_FALSE
#undef GL_TRUE
#undef GL_ZERO
#undef GL_ONE
