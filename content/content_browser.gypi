...

{
  ...
  'sources': [
    ...
    'browser/android/android_native_window.cc',
    'browser/android/android_native_window.h',
    'browser/android/jni_helper.cc',
    'browser/android/jni_helper.h',
    'browser/android/media_player_bridge.cc',
    'browser/android/media_player_bridge.h',
    'browser/android/media_player_listener.cc',
    'browser/android/media_player_listener.h',
    'browser/android/sandboxed_process_launcher.cc',
    'browser/android/sandboxed_process_launcher.h',
    'browser/android/sandboxed_process_service.cc',
    'browser/android/sandboxed_process_service.h',
    'browser/android/surface_texture_bridge.cc',
    'browser/android/surface_texture_bridge.h',
    'browser/android/surface_texture_listener.cc',
    'browser/android/surface_texture_listener.h',
    'browser/android/surface_texture_peer.cc',
    'browser/android/surface_texture_peer.h',
    'browser/android/user_agent.cc',
    'browser/android/user_agent.h',
    ...
    'browser/child_process_launcher_android.cc',
    ...
    'browser/device_orientation/device_orientation_android.cc',
    'browser/device_orientation/device_orientation_android.h',
    ...
    'browser/download/download_file_manager_android.cc',
    'browser/download/download_file_manager_android.h',
    'browser/download/download_info_android.cc',
    'browser/download/download_info_android.h',
    ...
    'browser/geolocation/android_location_api_adapter.cc',
    'browser/geolocation/android_location_api_adapter.h',
    ...
    'browser/media/media_player_delegate_android.cc',
    'browser/media/media_player_delegate_android.h',
    ...
    'browser/renderer_host/backing_store_android.cc',
    'browser/renderer_host/backing_store_android.h',
  ...
  'conditions': [
    ['OS != "android"', {
      ...
      'dependencies': [ '../third_party/speex/speex.gyp:libspeex', ],
    }],
      ...
      'actions': [
        {
          ...
          'inputs': [
            ...
            '../content/android/java/org/chromium/content/browser/DeviceInfo.java',
            '../content/android/java/org/chromium/content/browser/DeviceOrientation.java',
            '../content/android/java/org/chromium/content/browser/JNIHelper.java',
            '../content/android/java/org/chromium/content/browser/ImeAdapter.java',
            '../content/android/java/org/chromium/content/browser/LocationProvider.java',
            '../content/android/java/org/chromium/content/browser/MediaPlayerListener.java',
            '../content/android/java/org/chromium/content/browser/SandboxedProcessLauncher.java',
            '../content/android/java/org/chromium/content/browser/SandboxedProcessService.java',
            '../content/android/java/org/chromium/content/browser/SurfaceTextureListener.java',
          ...
          'outputs': [
            ...
            '<(SHARED_INTERMEDIATE_DIR)/content/jni/ime_adapter_jni.h',
            '<(SHARED_INTERMEDIATE_DIR)/content/jni/location_provider_jni.h',
            '<(SHARED_INTERMEDIATE_DIR)/content/jni/media_player_listener_jni.h',
