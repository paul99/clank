  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/download/download_controller_stub_android.cc',
        'browser/download/download_controller_stub_android.h',
      ...
      'conditions': [
        ...
        ['OS == "android"', {
          ...
          'sources': [
            # TODO(bulach): This overlaps with clank/native/native.gypi, which
            # is also used by chrome_tests.gyp and clank.gyp. The dependencies
            # for these JNI classes need to be straightened out.
            'browser/android/chrome_video_view.cc',
            'browser/android/chrome_video_view.h',
          ],
          'link_settings': {
            'libraries': [
