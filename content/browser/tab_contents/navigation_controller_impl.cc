...
void NavigationControllerImpl::ReloadWithOriginalURL() {
  ReloadInternal(false, RELOAD_WITH_ORIGINAL_URL);
}
...
void NavigationControllerImpl::LoadURL(
  ...
  if (GetLastCommittedEntry() && carry_over)
    override = GetLastCommittedEntry()->GetUserAgentOverride();
...
void NavigationControllerImpl::LoadURLWithUserAgentOverride(
  ...
  entry->SetUserAgentOverride(user_agent_override);
...
void NavigationControllerImpl::RendererDidNavigateToNewPage(
  ...
  new_entry->SetUserAgentOverride(params.user_agent_override);
