...
// TODO(nileshagrawal): These public methods are virtual because
// download_file_manager_android needs to override them. Either make these
// methods virtual in upstream too OR refactor the common functionality
// in an abstract class with 2 implementations.
class CONTENT_EXPORT DownloadFileManager
 ...
 public:
  ...
  CONTENT_EXPORT virtual void Shutdown();
  ...
  virtual void RenameInProgressDownloadFile(content::DownloadId id,
  ...
  virtual void RenameCompletingDownloadFile(content::DownloadId id,
                                            const FilePath& full_path,
