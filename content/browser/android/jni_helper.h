...
#define CLANK_EXPORT __attribute__ ((visibility("default")))
...
// ScopedJavaLocalRef.
base::android::ScopedJavaLocalRef<jobject> GetRealObject(JNIEnv* env, jobject obj);
...
// bitmaps originating from WebKit that we want to manipulate in the Java part
// of Clank (such as favicon).  Due to the extra copy, should be avoided for
// large or frequently used bitmaps.  Returns a local reference to the new
// bitmap.
