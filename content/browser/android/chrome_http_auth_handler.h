...
#ifndef CONTENT_BROWSER_ANDROID_CHROME_HTTP_AUTH_HANDLER_H_
#define CONTENT_BROWSER_ANDROID_CHROME_HTTP_AUTH_HANDLER_H_
#pragma once
...
// and a Java land ChromeHttpAuthHandler, which is passed to a ChromeViewClient
// to allow it to respond to HTTP authentication requests by, e.g., showing
// the user a login dialog.
...
#endif  // CONTENT_BROWSER_ANDROID_CHROME_HTTP_AUTH_HANDLER_H_
