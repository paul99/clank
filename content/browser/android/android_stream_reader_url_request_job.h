...
#ifndef ANDROID_STREAM_READER_URL_REQUEST_JOB_H
#define ANDROID_STREAM_READER_URL_REQUEST_JOB_H
#pragma once
...
class AndroidStreamReaderURLRequestJob : public net::URLRequestJob {
 public:
   ...
   * different contexts.
   */
  class Delegate : public base::NonThreadSafe {
   public:
...
#endif  // ANDROID_STREAM_READER_URL_REQUEST_JOB_H
