...
void TestRenderWidgetHostView::ShowPressStateAck(
    const std::vector<gfx::Rect>& rects) {
}

void TestRenderWidgetHostView::MultipleTargetsTouched(const gfx::Rect& rect,
                                                      const gfx::Size& size,
                                                      const TransportDIB* dib) {
}

void TestRenderWidgetHostView::ProcessTouchEndAck(
    const ViewHostMsg_TextInputState_Params& params) {
}

void TestRenderWidgetHostView::CompositorResized(uint64 timestamp,
                                                 const gfx::Size& size) {
}
