...
class CONTENT_EXPORT ResourceDispatcherHost : public net::URLRequest::Delegate {
 ...
 private:
  ...
  static const char kXAutoLogin[];  // Name of response header for x-auto-login.

  // Check for the presence of an x-auto-login header and respond appropriately.
  void CheckForAutoLogin(net::URLRequest* request);
#endif
