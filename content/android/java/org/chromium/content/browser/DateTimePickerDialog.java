...
class DateTimePickerDialog extends AlertDialog implements OnClickListener,
    ...
    public DateTimePickerDialog(Context context,
        ...
        setButton(BUTTON_POSITIVE, context.getText(
                ChromeView.getResourceId("R.string.date_picker_dialog_set")), this);
        setButton(BUTTON_NEGATIVE, context.getText(android.R.string.cancel),
                (OnClickListener) null);
        setIcon(0);
        setTitle(context.getText(
                ChromeView.getResourceId("R.string.date_time_picker_dialog_title")));

        LayoutInflater inflater =
                (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(
                ChromeView.getResourceId("R.layout.date_time_picker_dialog"), null);
        setView(view);
        mDatePicker = (DatePicker) view.findViewById(ChromeView.getResourceId("R.id.datePicker"));
        mDatePicker.init(year, monthOfYear, dayOfMonth, this);

        mTimePicker = (TimePicker) view.findViewById(ChromeView.getResourceId("R.id.timePicker"));
    ...
    protected void onStop() {
        // TODO(olilan): change to use Build.VERSION_CODES.JELLY_BEAN when possible.
