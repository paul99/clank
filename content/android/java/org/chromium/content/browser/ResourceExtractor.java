...
public class ResourceExtractor {
    ...
    private class ExtractTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... unused) {
            ...
            // The minimum set of .pak files Chrome needs. Listed here in a format that is
            // regex and grep friendly.
            String[] mandatoryPaks = {"chrome.pak", "en-US.pak", "resources.pak"};
            ...
            if (prefs.getString(LAST_LANGUAGE, "").equals(currentLanguage)
                    &&  filenames.size() >= mandatoryPaks.length) {
            ...
            for (String mandatoryPak : mandatoryPaks) {
            ...
            // so that we unpack the correct .pak file (see http://b/6504501).
            if (currentLanguage.equals("in")) {
                currentLanguage = "id";
            } else if (currentLanguage.equals("iw")) {
                currentLanguage = "he";
            }
            // Uncomment these lines to support Yiddish:
    ...
    public void waitForCompletion() {
        ...
        try {
            ...
            // Don't leave the files in a inconsistent state.
            deleteFiles(mContext);
        }
