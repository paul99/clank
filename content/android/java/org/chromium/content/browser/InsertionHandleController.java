...
/*
 * This class is based on InsertionPointCursorController, the private inner
...
abstract public class InsertionHandleController implements CursorController {
    ...
    public boolean isHiddenTemporarily() {
        if (mHandle != null) return mHandle.getVisibility() == View.INVISIBLE;
        return false;
    }

    public void hideTemporarily() {
        if (mHandle != null) mHandle.setVisibility(View.INVISIBLE);
    }
