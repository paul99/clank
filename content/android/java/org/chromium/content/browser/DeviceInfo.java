...
public class DeviceInfo {
  ...
  public double getRefreshRate() {
      ...
      if (result >= 61 || result < 30) {
          // http://b/issue?id=5572464
          // Some devices report an incorrect value (usually 68Hz) due to a driver bug.
          // At least one device returns 60.144 and this is probabably correct. Assume
          // values outside the 30-60 range are wrong, and return 0 (unknown) instead.
          // TODO(husky): Remove this hack when all suppported devices work properly.
          return 0;
      }
      return result;
  }
