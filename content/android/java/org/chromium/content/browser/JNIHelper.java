...
class JNIHelper {
    // Holder for content backing store bitmaps of all ChromeViews.  Note that when in software mode,
    // this will be one of the main consumers of RAM in Clank Java code.  This data structure exists
    // solely to prevent garbage collection and expose the allocations to the DDMS tool.  The backing
