...
// TODO(olilan): Once we have framework access, try replacing this with a DatePicker.
public class MonthPicker extends FrameLayout {
    ...
    public MonthPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(ChromeView.getResourceId("R.layout.month_picker"), this, true);
        ...
        mSpinners = (LinearLayout) findViewById(ChromeView.getResourceId("R.id.pickers"));

        // month
        mMonthSpinner = (NumberPicker) findViewById(ChromeView.getResourceId("R.id.month"));
        ...
        // year
        mYearSpinner = (NumberPicker) findViewById(ChromeView.getResourceId("R.id.year"));
