...
class AndroidProtocolAdapter {
    ...
    private static InputStream openResource(Context context, Uri uri) {
        ...
        try {
            ...
            final Class<?> d = context.getClassLoader()
                .loadClass(context.getPackageName() + ".R$" + assetType);
            final java.lang.reflect.Field field = d.getField(assetName);
    ...
    public static void setResourceContext(Context context) {
        nativeSetResourceContext(context);
    }

    private static native void nativeSetResourceContext(Context context);
