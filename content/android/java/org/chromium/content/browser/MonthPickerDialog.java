...
public class MonthPickerDialog extends AlertDialog implements OnClickListener,
    ...
    public MonthPickerDialog(Context context,
        ...
        setIcon(0);
        setTitle(ChromeView.getResourceId("R.string.month_picker_dialog_title"));

        LayoutInflater inflater =
                (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(
                ChromeView.getResourceId("R.layout.month_picker_dialog"), null);
        setView(view);
        mMonthPicker = (MonthPicker) view.findViewById(
                ChromeView.getResourceId("R.id.datePicker"));
