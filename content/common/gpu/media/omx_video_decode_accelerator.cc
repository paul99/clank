...
// them.
#ifdef OS_ANDROID
class SharedMemoryAndId {
 public:
  scoped_ptr<base::SharedMemory> first;
  int32 second;
};
#else
...
// TODO(MERGE): //dlopen("libnvomx.so", RTLD_NOW);
...
OMXInit omx_init = NULL; //reinterpret_cast<OMXInit>(dlsym(omx_handle, "OMX_Init"));
