...
static PFNEGLCREATEIMAGEKHRPROC egl_create_image_khr = NULL;
// TODO(MERGE): This may have been causing us to fail to load libchromeview.so
/*
    reinterpret_cast<PFNEGLCREATEIMAGEKHRPROC>(
        eglGetProcAddress("eglCreateImageKHR"));
*/
static PFNEGLDESTROYIMAGEKHRPROC egl_destroy_image_khr = NULL;
/*
