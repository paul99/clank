...
RendererWebKitPlatformSupportImpl::SandboxSupport::getFontFamilyForCharacters(
  ...
  // TODO: megamerge implement RendererWebKitPlatformSupportImpl::SandboxSupport::getFontFamilyForCharacters()
  NOTIMPLEMENTED();
#else
...
RendererWebKitPlatformSupportImpl::SandboxSupport::getRenderStyleForStrike(
    const char* family, int sizeAndStyle, WebKit::WebFontRenderStyle* out) {
#if defined(OS_ANDROID)
  // TODO: megamerge implement RendererWebKitPlatformSupportImpl::SandboxSupport::getRenderStyleForStrike()
  NOTIMPLEMENTED();
#else
