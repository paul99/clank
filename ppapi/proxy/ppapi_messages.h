...
// PPB_Flash_Mobile
IPC_MESSAGE_ROUTED2(PpapiHostMsg_PPBFlashMobile_SetWakeLock,
                    PP_Instance /* instance */,
                    PP_Bool /* stay_awake */)

IPC_SYNC_MESSAGE_ROUTED1_1(PpapiHostMsg_PPBFlashMobile_IsWakeLock,
                           PP_Instance /* instance */,
                           PP_Bool /*result*/ )

IPC_MESSAGE_ROUTED2(PpapiHostMsg_PPBFlashMobile_SetKeyboardVisible,
                    PP_Instance /* instance */,
                    PP_Bool /* visible */)

IPC_SYNC_MESSAGE_ROUTED1_1(PpapiHostMsg_PPBFlashMobile_GetScreenOrientation,
                           PP_Instance /* instance */,
                           int32_t /*result*/ )

IPC_MESSAGE_ROUTED3(PpapiHostMsg_PPBFlashMobile_SetOrientationLocked,
                    PP_Instance /* instance */,
                    PP_Bool /* locked */,
                    int32_t /* orientation */)

IPC_SYNC_MESSAGE_ROUTED1_1(PpapiHostMsg_PPBFlashMobile_IsOrientationLocked,
                           PP_Instance /* instance */,
                           PP_Bool /*result*/ )
