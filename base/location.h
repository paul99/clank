...
// Enable tracing on Android non-official release builds, as Debug builds
// aren't generally used.
#if !defined(TRACK_ALL_TASK_OBJECTS) && !defined(GOOGLE_CHROME_BUILD)
#define TRACK_ALL_TASK_OBJECTS
#endif  // !defined(TRACK_ALL_TASK_OBJECTS) && !defined(GOOGLE_CHROME_BUILD)
