...
def JavaParamToJni(param):
  ...
  app_param_map = {
      'ChromeView':
      'Lorg/chromium/content/browser/ChromeView',
      ...
      'JSModalDialog':
      'Lcom/google/android/apps/chrome/JSModalDialog',
      ...
      'SandboxedProcessArgs': 'Lorg/chromium/content/browser/SandboxedProcessArgs',
      ...
      'BookmarkNode': 'Lcom/google/android/apps/chrome/ChromeBrowserProvider$BookmarkNode',

      'SQLiteCursor': 'Lcom/google/android/apps/chrome/database/SQLiteCursor',
      ...
      'Lorg/chromium/content/browser/ChromeView$ChromeViewContextMenuInfo',

      'AutofillData': 'Lorg/chromium/content/browser/AutofillData',

      'JavaInputStream': 'Lorg/chromium/content/browser/JavaInputStream',

      'ChromeVideoView': 'Lorg/chromium/content/browser/ChromeVideoView',

      'ChromeHttpAuthHandler': 'Lorg/chromium/content/browser/ChromeHttpAuthHandler',

      'ProxyChangeListener':
      'Lorg/chromium/content/browser/net/ProxyChangeListener',

      'WaitableNativeEvent': 'Lorg/chromium/content/browser/WaitableNativeEvent',
  }
  if param == 'byte[][]':
    return '[[B'
  prefix = ''
