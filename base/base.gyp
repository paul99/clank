...

{
  ...
  'targets': [
    {
      'target_name': 'base_jni_headers_tests',
      'type': 'none',
      'actions': [
        {
          'action_name': 'base_generate_jni_headers',
          'inputs': [
              'android/jni_generator/jni_generator.py',
              'test/android/ChromeNativeTestActivity.java',
          ],
          'outputs': [
              '<(SHARED_INTERMEDIATE_DIR)/base/jni/chrome_native_test_activity_jni.h',
          ],
          'action': [
            'python',
            'android/jni_generator/jni_generator.py',
    ...
    },
    {
      ...
      'sources': [
        ...
        'stringprintf_unittest.cc',# TODO(bulach): move this file out of clank.
