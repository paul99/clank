...
class LighttpdServer(object):
  ...
  def __init__(self, document_root, port=None,
    ...
    self.port = port or run_tests_helper.LIGHTTPD_DEFAULT_PORT
  ...
  def _GetRandomPort(self):
    # The ports of test server is arranged in run_tests_helper.py.
    return random.randint(run_tests_helper.LIGHTTPD_RANDOM_PORT_FIRST,
                          run_tests_helper.LIGHTTPD_RANDOM_PORT_LAST)
